...
public class ComparadorRecomendaciones implements Comparator<Recomendacion> {
	...
	// OPCION 2
	// Promociones que le gustan - Promociones que no - Atracciones que le gustan -
	// Atracciones que no
	/*
	 * if(o1.esPromocion() && !o2.esPromocion()) { return -1; }else
	 * if(!o1.esPromocion() && o2.esPromocion()) { return 1; }
	 * 
	 * else if (o1.getTipoDeRecomendacion().ordinal() == TipoOrden.ordinal() &&
	 * o2.getTipoDeRecomendacion().ordinal() != TipoOrden.ordinal()) return -1;
	 * 
	 * else if (o1.getTipoDeRecomendacion().ordinal() != TipoOrden.ordinal() &&
	 * o2.getTipoDeRecomendacion().ordinal() == TipoOrden.ordinal()) return 1;
	 * 
	 * else if (o1.getPrecio() == o2.getPrecio()) return
	 * Double.compare(o2.getTiempo(), o1.getTiempo());
	 * 
	 * return Double.compare(o2.getPrecio(), o1.getPrecio()); }
	 */
